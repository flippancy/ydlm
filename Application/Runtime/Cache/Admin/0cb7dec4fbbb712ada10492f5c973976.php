...
<!-- 				<li class="">
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <form action="/ydlm/admin.php/Folder/upload" class="dropzone" id="my-awesome-dropzone">
            </form>
        </div>
    </div>
    ...
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>文件信息列表</div>
            <div class="tools">
                        ...
                        <td class="delete" align="center">
                            ...
                            <div id="delete<?php echo ($vo["id"]); ?>" class="modal hide fade" tabindex="-1" data-backdrop="delete" data-keyboard="false">
                                ...
                                <div class="modal-footer">
                                    <button type="button" data-dismiss="modal" onclick="location.href='/ydlm/admin.php/Folder/delete?id=<?php echo ($vo["id"]); ?>'" class="btn green">确定</button>
