...
<!-- 				<li class="">
    ...
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>沙龙列表</div>
            <div class="tools">
            ...
            <table class="table-bordered table-striped table-condensed cf">
                ...
                <thead class="cf">
                    ...
                    <tr>
                        ...
                        <th class="numeric">说明</th>
                        <th class="numeric">文档路径</th>
                        <th class="numeric">源代码路径</th>
                        <th class="numeric">ppt路径</th>
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody class="file">
                    <tr class="template-domeload dade in">
                        ...
                        <td class="file"><?php echo ($vo["file"]); ?><a class="" href="/ydlm/admin.php/Salon/download?file=<?php echo ($vo["file"]); ?>" data-toggle="modal"><i class="icon-download-alt"></i></a></td>
                        <td class="mainfile"><?php echo ($vo["mainfile"]); ?><a class="" href="/ydlm/admin.php/Salon/download?file=<?php echo ($vo["mainfile"]); ?>" data-toggle="modal"><i class="icon-download-alt"></i></a></td>
                        <td class="pptfile"><?php echo ($vo["pptfile"]); ?><a class="" href="/ydlm/admin.php/Salon/download?file=<?php echo ($vo["pptfile"]); ?>" data-toggle="modal"><i class="icon-download-alt"></i></a></td>
                        <td class="author"><?php echo ($vo["author"]); ?></td>
                        <td class="date"><?php echo ($vo["date"]); ?></td>
                        <td class="delete" align="center">
                            <a class="" href="#delete<?php echo ($vo["id"]); ?>" data-toggle="modal"><i class="icon-trash"></i></a>
                            <a class="" href="#update<?php echo ($vo["id"]); ?>" data-toggle="modal"><i class="icon-edit"></i></a>
                            <a class="" onclick="location.href='/ydlm/admin.php/Salon/change?id=<?php echo ($vo["id"]); ?>'"><i class="icon-check"></i></a>
                            ...
                            <div id="delete<?php echo ($vo["id"]); ?>" class="modal hide fade" tabindex="-1" data-backdrop="delete" data-keyboard="false">
                                ...
                                <div class="modal-footer">
                                    <button type="button" data-dismiss="modal" onclick="location.href='/ydlm/admin.php/Salon/delete?id=<?php echo ($vo["id"]); ?>'" class="btn green">确定</button>
                                        ...
                                        <div class="portlet-body form">
                                            <form form action="/ydlm/admin.php/Salon/update?id=<?php echo ($vo["id"]); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" class="span6 m-wrap" name="name" value="<?php echo ($vo["name"]); ?>"/>
...
<!-- 未审批项目列表 -->
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>未审批沙龙列表</div>
            <div class="tools">
                <a href="#add" data-toggle="modal"><b>添加列表</b></a>
                <a href="javascript:;" class="collapse"></a>
                <!-- <a href="#portlet-config" data-toggle="modal" class="config"></a> -->
                <!-- <a href="javascript:;" class="reload"></a> -->
                <!-- <a href="javascript:;" class="remove"></a> -->
                ...
                <?php if(is_array($list_no)): $i = 0; $__LIST__ = $list_no;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody class="file">
                    <tr class="template-domeload dade in">
                        ...
                        <td class="delete" align="center">
                            <a class="" href="#delete<?php echo ($vo["id"]); ?>" data-toggle="modal"><i class="icon-trash"></i></a>
                            <a class="" href="#update<?php echo ($vo["id"]); ?>" data-toggle="modal"><i class="icon-edit"></i></a>
                            <a class="" onclick="location.href='/ydlm/admin.php/Salon/change?id=<?php echo ($vo["id"]); ?>'"><i class="icon-check-empty"></i></a>
