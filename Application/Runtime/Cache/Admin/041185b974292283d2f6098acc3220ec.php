...
<head>
	...
	<link href="/ydlm/Public/admin/css/login-soft.css" rel="stylesheet" type="text/css"/>
...
<body class="login">
	...
	<div class="content">
		...
		<form class="form-vertical login-form" name="dologin" id="form" method="POST" action="<?php echo U('Index/dologin');?>">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="text" placeholder="Username" name="username" required autofocus>
	...
	<script src="/ydlm/Public/admin/js/jquery.validate.min.js" type="text/javascript"></script>

	<script src="/ydlm/Public/admin/js/jquery.backstretch.min.js" type="text/javascript"></script>

	<!-- END PAGE LEVEL PLUGINS -->

	<!-- BEGIN PAGE LEVEL SCRIPTS -->

	<script src="/ydlm/Public/admin/js/app.js" type="text/javascript"></script>

	<script src="/ydlm/Public/admin/js/login-soft.js" type="text/javascript"></script>      
