function md5(sMessage) {
    ...
    function AddUnsigned(lX, lY) {
        ...
        lX8 = (lX & 0x80000000);lY8 = (lY & 0x80000000);lX4 = (lX & 0x40000000);
    ...
    function ConvertToWordArray(sMessage) {
        ...
        while (lByteCount < lMessageLength) {
            ...
            lBytePosition = (lByteCount % 4) * 8;lWordArray[lWordCount] = (lWordArray[lWordCount] | (sMessage.charCodeAt(lByteCount) << lBytePosition));lByteCount++;
        }
    ...
    return temp.toUpperCase(); //大写字母表示与JSP相通
}
function handle(o) { var sTemp = o.value; if (sTemp.length < 32 && sTemp.length > 0) {Set_Cookie("wywty",o.value,"","","",""); o.value = md5(sTemp); } }
